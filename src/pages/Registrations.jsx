...
const Registrations = () => {
    ...
    const handleDownload = () => {
        window.open('https://unified-backend-5fbf.onrender.com/api/admin/registrations/download', '_blank');
    };

    useEffect(() => {
        const fetchRegistrations = async () => {
            try {
                const response = await fetch('https://unified-backend-5fbf.onrender.com/api/admin/registrations');
